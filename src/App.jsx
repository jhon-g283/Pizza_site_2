 ...
 */
  ...
  render() {
    ...
    const side_list_edit_mode = (
      <div className=" sidelist  test_border_1" style={style_x}>
        <p id="menubtn" onClick={() => this.click_selection_tag(event, "menu")}>
          menu
        </p>
        <div>{this.state.flg_sidebar ? <p id="createbtn">作成</p> : ""}</div>
        ...
        <div>{this.state.flg_sidebar ? <p id="ordderbtn">注文へ</p> : ""}</div>
      </div>
    );
    ...
    const side_list_review_mode = (
      ...
      <div className="sidelist2 back_to_edit">
    ...
    //   <div>
    //     <div className="sidelist  test_border_1" style={style_x}>
    //       <p onClick={() => this.click_selection_tag(event, "menu")}>aa</p>
    //     </div>
    //     <div>{this.state.flg_sidebar ? "" : sidelist}</div>
    //   </div>
    // );

    // main_switch=this.state.flg_sidebar ? sidelist : "";

    // main_switch = sidelist;
    // main_switch=main_switch+this.state.flg_sidebar?sidelist:""
    ...
    return (
      <div className="App">
        ...
        <div className="div_canv test_border_1">
          <canvas
            id="review_wcanvas"
            // className="review_canvas test_border_1 review_canvas2"
          ...
          {this.state.flg_input ? (
            <div style={style_order_info}>
              <InputOrderInfo
                close_fnc={this.Change_To_Edit}
                topping={this.state.canvas_topping}
                range={this.state.range_obj2}
              />
            </div>
          ) : (
            // ガイド用のキャンバス
